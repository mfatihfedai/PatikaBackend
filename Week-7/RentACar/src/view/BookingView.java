...
public class BookingView extends Layout{
    ...
    private JTextField texta_book_note;
    ...
    public BookingView(Car selectedCar, String strt_date, String fnsh_date){
        ...
        this.fld_strt_date.setText(strt_date);
        this.fld_fnsh_date.setText(fnsh_date);

        //test için
        this.fld_book_name.setText("Mustafa Çetindağ");
        this.fld_book_idno.setText("12345678912");
        this.fld_book_mail.setText("test@patika.dev");
        this.fld_book_mpno.setText("05512221133");
        this.fld_book_prc.setText("2350");
        this.texta_book_note.setText("Not bırakıldı.");
        ...
        btn_book_save.addActionListener(e -> {
            ...
            if (Helper.isFieldListEmpty(checkFieldList)){
                ...
                book.setNote(this.texta_book_note.getText());
